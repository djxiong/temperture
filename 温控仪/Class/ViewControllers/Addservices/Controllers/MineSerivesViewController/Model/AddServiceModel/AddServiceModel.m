...
-(NSString *)description{
    ...
    return [NSString stringWithFormat:@"typeSn--%@ , typeName--%@ , typeNumber--%@ , protocol--%@ , bindUrl--%@ , brand--%@ , _devSn--%@ , _indexUrl--%@" , _typeSn , _typeName , _typeNumber ,  _protocol , _bindUrl , _brand , _devSn , _indexUrl];
}
